...
(() => {
  ...
  requestAnimationFrame(() => {console.log('ra 1')})
  setTimeout(() => console.log("setTimeout 1"));
  Promise.resolve('promise 1').then(r => console.log(r))
  console.log("normal 2");
  setTimeout(() => console.log('setTimeout 2'))
  console.log("normal 3");
  Promise.resolve("promise 2").then((r) => console.log(r))
  setTimeout(() => console.log("setTimeout 3"));
  requestAnimationFrame(() => {
    console.log("ra 2");
  });
  setTimeout(() => {
    Promise.resolve("promise 3").then((r) => console.log(r));
    setTimeout(() => console.log("setTimeout 3"));
    requestAnimationFrame(() => {
      console.log("ra 3");
    });
    Promise.resolve("promise 4").then((r) => console.log(r));
    requestAnimationFrame(() => {
      console.log("ra 4");
    });
